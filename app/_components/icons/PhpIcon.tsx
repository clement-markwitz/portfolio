...
export const PhpIcon = (props: ComponentPropsWithoutRef<"svg"> & {size?: number}) => {
   ...
   <defs>
        <radialGradient id="radialGradient-1" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
            <stop offset="0%" stopColor="#6181B6" stopOpacity="1"></stop>
            <stop offset="100%" stopColor="#6181B6" stopOpacity="0"></stop>
        </radialGradient>
	</defs>
	<g>
